...
echo
	...
	echo "Building version                       : "$hefftorlinuxversion
...
echo "- Git clone the latest HefftorLinux-iso from github"
tput sgr0
echo "################################################################## "
echo
